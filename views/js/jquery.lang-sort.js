...
$(document).ready(function() {
    $('#lang-sort').on('init.field.fv', function(e, data) {
	...
	/*err: {
		...
		//row: '.col-xs-4',
			...
			min: 7,
                        max: 9,
                        message: "Langue sélectionnée non valide"
                    },
		    regexp: {
                            regexp: /^(anglais|espagnol|italien|français|portugais|breton|autre)$/,
                            message: "Langue sélectionnée non valide"
                    }
                }
            },
    ...
    .on('success.form.fv', function(e) {
        ...
        .on('err.field.fv', function(e, data) {
            ...
            $('#lang-sort-errors').find('li[data-field="' + data.field + '"]').remove();
                    ...
                    .wrapInner(
                        $('<a/>')
                            ...
                            .on('click', function(e) {
                                ...
                                $('#lang-sort').modal('hide');

                                // Focus on the invalid field
                                data.element.focus();
                            })
                    )
                    .appendTo('#lang-sort-errors');
            }
...
///// CONSERVE ALL OF THESE FOLLOWING SETTINGS //////////
    ...
    .on('success.form.fv', function(e) {
		...
		fv.defaultSubmit()//.on('click', function(e) {
                         // Hide the modal first
			 //alert('TEST');
                         //$('#lang-sortSucceed').modal('show');;

		//('#lang-sort').click(function
