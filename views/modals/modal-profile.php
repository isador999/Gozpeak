		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form role="form" data-toggle="validator" class="form-vertical" name="profileForm" id="profileForm" method="post" action="">
					...
					<?php } ?>
					<?php foreach($modal[$_SESSION['language']]['profile']['select'] as $key => $value) { ?>
					<div class="form-group">
						<label class="col-lg-4 control-label right-modal" for="<?php echo $value; ?>"><?php echo $value['label']; ?>&nbsp;&#42;</label>
...
<div class="modal fade" id="modalProfileDeletion" tabindex="-1" role="dialog" aria-labelledby="ModalProfileDeletion">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="modalProfileDeletion"><?php echo $modal[$_SESSION['language']]['profiledeletion']['title']; ?></h4>
			</div>
			<div class="modal-body">
				<form role="form" data-toggle="validator" class="form-vertical" name="profiledeletionForm" id="profiledeletionForm" method="post" action="">
					<!-- The messages container -->
                                        <div id="profiledeletion-errors" class="profiledeletion-errors"></div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $modal['fr']['generic']['closed']; ?></button>
				<button type="button" value="<?php echo $modal['fr']['profiledeletion']['check']['submit']; ?>" class="btn btn-danger"><?php echo $modal['fr']['profiledeletion']['check']['desc']; ?></button>
			</div>
			</form>
		</div>
	</div>
