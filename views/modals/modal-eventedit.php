...
<div class="modal fade" style="display:none;" id="modalEditEvent" tabindex="-1" role="dialog" aria-labelledby="ModalEditEvent">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title text-center"><?php echo $modal[$_SESSION['language']]['editevent']['title']; ?> <span> <img id="EditEventTitle"></span> </h4>
      </div>
      ...
      <form role="form" data-toggle="validator" class="vertical-form posteventForm" name="eventForm" id="eventForm" method="post" action="<?php echo $baseUrl.'/controllers/postevent.php' ?>">
        <div class="modal-body">
          <div class="container-fluid">
            <div class="row">
              <div id="editevent-errors" class="text-left col-lg-offset-1 modal-errors"></div>
            </div>

            <div class="row">
              <div class="col-lg-5 EditEventImg">
                <img style="width: 92%;" id="EditEventImg" alt="logo">
              </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" value="Submit" class="btn btn-primary pull-right"><?php echo $modal[$_SESSION['language']]['editevent']['check']['desc']; ?></button>
        </div>
      </form>
    </div>
  </div>
