	...
	<div class="listing-events row">
								...
								<div id="dropdown-eventmonths" class="dropdown col-lg-6 col-md-7 col-sm-6 col-xs-6">
									...
									<ul id="event-months" class="dropdown-menu">
										<?php foreach ($list[$_SESSION['language']]['monthpicker']['option'] as $month) { ?>
											<li id="events-<?php echo $month['value']; ?>"><a onclick="sortEvents('<?php echo $baseUrl ?>', 'event', '<?php echo $query; ?>', document.getElementById('current_picked_eventyear').innerHTML, '<?php echo $month['entry'] ?>')" href="#"> <?php echo $month['entry']; ?> </a></li>
										<?php } ?>
									</ul>
								</div>

								<div id="dropdown-eventyears" class="dropdown col-lg-4 col-md-7 col-sm-4 col-xs-5">
		...
		<div class="eventsblock col-lg-offset-1 col-lg-6 col-md-offset-1 col-md-6">
			<fieldset class="scheduler-border">
				<legend class="scheduler-border">
					<div class="row">
						<div class="col-lg-5 col-md-6 col-sm-7 col-xs-5 text-left ideas-title">
							Vos <img src="views/images/zpeak_bleu.png" style="width:80px;" alt="Zpeak"/> idées d'événements
						</div>

						<div class="row zpeakdropdowns">
							<div class="col-lg-7 col-md-6 col-sm-5 col-xs-7 row">
								<div id="dropdown-ideamonths" class="dropdown col-lg-6 col-md-7 col-sm-6 col-xs-6">
									...
									<ul id="idea-months" class="dropdown-menu">
										<?php foreach ($list[$_SESSION['language']]['monthpicker']['option'] as $month) { ?>
											<li id="ideas-<?php echo $month['value']; ?>"><a onclick="sortEvents('<?php echo $baseUrl ?>', 'idea', '<?php echo $query; ?>', document.getElementById('current_picked_ideayear').innerHTML, '<?php echo $month['entry'] ?>')" href="#"> <?php echo $month['entry']; ?> </a></li>
										<?php } ?>
									</ul>
								</div>

								<div id="dropdown-ideayears" class="dropdown col-lg-4 col-md-7 col-sm-4 col-xs-5">
